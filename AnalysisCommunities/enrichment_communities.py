...
dico_cluster_diseases_10_0_7 = create_cluster_dico("cluster_output_10_0.7.tsv")
print(dico_cluster_diseases_10_0_7)
...
filtered_dico_cluster_10_0_7 = filter_cluster(dico_cluster_diseases_10_0_7)
print(filtered_dico_cluster_10_0_7)
